 ...
 *
 * No positioning classes here on purpose: this is mounted as a flex item
 * inside FloatingActions, which owns the fixed placement, the pairing with
 * the shopping-assistant launcher, and the checkout route hide — see that
 * file for why they are grouped in one place.
 */
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="z-40 flex h-12 w-12 items-center justify-center rounded-full bg-gold text-charcoal shadow-lg transition-transform hover:scale-105 focus-visible:scale-105 print:hidden"
    >
