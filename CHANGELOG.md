...
* הודעת טקסט שנשלחת לעוזר מוצגת מיד בתמליל ללא חיווי ״חשיבה״ כללי. Gemini
  ...
  חיפוש. שכבת קריאת הביניים והסימון הפנימי הוסרו. כל קריאת Gemini מוגבלת ל־25
  שניות, ונוסף ניסיון תקשורת חוזר יחיד בכל הודעה, גם לפני קריאת כלי וגם לאחר
  שהכלי החזיר מידע. שאלת ההמשך האחרונה של העוזר נשלחת כהקשר לא־מהימן ללא גוף
  התשובה העובדתי, כך שתשובות קצרות כמו ״כן״ נשארות מובנות ועדיין מחייבות בדיקה
  מחדש באתר באותו תור. מנגנון ההארקה לא השתנה.
