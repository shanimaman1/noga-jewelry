...
* פס האמון בעמוד המוצר מציג ״משלוח חינם״ כשהמחיר כבר עומד בסף המשלוח
  החינמי, ואת הסף עצמו רק כשהמוצר זול ממנו. ההחלטה נגזרת ממחיר המוצר ומנתוני
  המשלוח המשותפים.
...
* עלות המשלוח רוכזה לצד זמני המסירה ב־`src/lib/fulfillment.ts`: משלוח לבית
  עולה ₪35 וחינם מעל ₪1,000, ואיסוף מהסטודיו חינם. העלות והמרחק ממשלוח חינם
  מוצגים בעמוד המוצר, במגירת העגלה, בעמוד העגלה ובסיכום הצ׳קאאוט.
