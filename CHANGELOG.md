...
* בקשות גלישה פתוחות בעוזר, כגון מתנה לאימא או חיפוש של משהו עדין, מחייבות
  כעת קריאת כלי כבר בסבב Gemini הראשון ומפעילות חיפוש קטלוג רחב גם ללא
  מסננים. שאלות על דמי משלוח, הנחות והחזרות ממשיכות לקבל תשובה כנה והפניית
  WhatsApp. נוסף לוג שרת מינימלי של כלים, ארגומנטים בטוחים, מספר תוצאות
  והאם סורק ההארקה החליף טקסט, ללא תוכן משתמשת או מזהים.
