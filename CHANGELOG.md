...
* הודעת טקסט שנשלחת לעוזר מוצגת כעת מיד בתמליל, ובזמן ההמתנה ל־Gemini מוצג
  החיווי הנגיש והניטרלי ״חושבת...״. החיווי אינו טוען שנעשה חיפוש באתר כשלא
  נדרש כלי, מכבד reduced motion ונעלם כשהתשובה האמיתית מגיעה; הוא אינו תבנית
  תשובה ואינו משנה את מנגנון ההארקה.
