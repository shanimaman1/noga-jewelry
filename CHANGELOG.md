...
* הודעת טקסט שנשלחת לעוזר מוצגת כעת מיד בתמליל, ובזמן ההמתנה ל־Gemini ולכלי
  האתר מוצג החיווי הנגיש ״בודקת באתר...״. החיווי מכבד reduced motion ונעלם
  כשהתשובה האמיתית מגיעה; הוא אינו תבנית תשובה ואינו משנה את מנגנון ההארקה.
