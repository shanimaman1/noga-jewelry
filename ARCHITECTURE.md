...
בכרטיס אשראי הצ׳קאאוט מציע תשלום אחד או שלושה תשלומים. `lib/format.ts` מחלק
את הסכום השלם בלי לעגל את הסך, ומעביר שארית לתשלום הראשון. הבחירה נשמרת
ב־snapshot של הזמנת ההדגמה ומוצגת באישור. Bit ו־Apple Pay נשארים בתשלום אחד.
