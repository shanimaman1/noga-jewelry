...
| מה | איפה | הערה |
| --- | --- | --- |
| פריטים, מחירים, מתכות, אבנים, משקל זהב וזמינות | `src/data/products.ts` | 16 פריטים, ₪890–₪10,200 כולל גרסאות 18 קראט |
...
`products.ts`, ולכן slug שגוי לא מציג כרטיס. פרטי מוצר, אבנים, משקל זהב,
זמינות, זמני מסירה
...
* שם, מחיר, קטגוריה, מתכת, אבנים ומשקל זהב נקראים תמיד מ־`products.ts` — אף
  אחד מהם לא נכתב
